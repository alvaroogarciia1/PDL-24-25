...
public class GramaticaAS{
    ...
    public GramaticaAS(){
        ...
        */
        ...
        // Regla 24. S -> return X ;
        tabla.put("S return", "24 return X puntoycoma {24}");
        // Regla 25. D -> = E
        ...
        // Regla 36. B -> S
        tabla.put("B id", "36 S {36}");
        tabla.put("B input", "36 S {36}");
        tabla.put("B alert", "36 S {36}");
        tabla.put("B return", "36 S {36}");
        // Regla 37. B -> switch ( E ) { Y }
        tabla.put("B switch", "37 switch parenta E {37.1} parentc corcha Y corchc {37.2}");
        // Regla 38. Y -> case entero : C M 
        tabla.put("Y case", "38 case entero dospuntos C M {38}");
        // Regla 39. M -> break ; N
        tabla.put("M break", "39 break puntoycoma N {39}");
        // Regla 40. M -> N
        tabla.put("M corchc", "40 N {40}");
        tabla.put("M case", "40 N {40}");
        tabla.put("M default", "40 N {40}");
        // Regla 41. N -> Y
        tabla.put("N case", "41 Y {41}");
        // Regla 42. N -> default : C 
        tabla.put("N default", "42 default dospuntos C {42}");
        // Regla 43. N -> lambda
        ...
        tabla.put("F function", "47 function H id {47.1} parenta A parentc {47.3} corcha C corchc {47.4}");
        //Regla 48. H -> T
        ...
        //Regla 54. C -> B C
        tabla.put("C if", "54 B C {54}");
        tabla.put("C let", "54 B C {54}");
        tabla.put("C id", "54 B C {54}");
        tabla.put("C input", "54 B C {54}");
        tabla.put("C alert", "54 B C {54}");
        tabla.put("C return", "54 B C {54}");
        tabla.put("C switch", "54 B C {54}");
        //Regla 55. C -> lambda
        tabla.put("C corchc", "55 lambda {55}");
        tabla.put("C case", "55 lambda {55}");
        tabla.put("C break", "55 lambda {55}");
        tabla.put("C default", "55 lambda {55}");
        //Regla 56. P -> BP
        tabla.put("P if", "56 B P {56}");
        tabla.put("P let", "56 B P {56}");
        tabla.put("P id", "56 B P {56}");
        tabla.put("P input", "56 B P {56}");
        tabla.put("P alert", "56 B P {56}");
        tabla.put("P return", "56 B P {56}");
        tabla.put("P switch", "56 B P {56}");
        //Regña 57. P -> FP
        tabla.put("P function", "57 F P {57}");
        //Regla 58. P -> lambda
        tabla.put("P $", "58 lambda");
        //Regla 59. P -> eof
        tabla.put("P eof","59 eof {59}");
    }
